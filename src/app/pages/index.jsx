...
export default function Index() {
  ...
  return (
      <Router>
        <div className="relative min-h-screen bg-[url('/img.jpg')] bg-cover bg-fixed bg-center flex w-full">
          ...
          <motion.div
            ...
            <motion.div 
              ...
              className="w-full flex items-center justify-center p-20 bg-white bg-opacity-50 backdrop-blur-lg rounded-lg" style={{ height: '110%' }}>
              {
                !showSideBar && 
                <button  
                onClick={() => setHideBar(true)} 
                className="text-white hover:bg-blue-300 rounded px-4 py-2 mb-4 absolute top-0 left-0"
              >
