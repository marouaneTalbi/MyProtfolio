...
export default function Welcom() {
  ...
  const [hideBloc, setHideBoloc] = useState(false);
  ...
  return (
    // <section className="h-full p-0  bg-cover bg-center backdrop-blur-lg overflow-hidden"  >
    <section className="h-full p-0  bg-cover bg-center backdrop-blur-lg overflow-hidden"  >


        <div className="min-h-screen  flex items-center justify-center p-20 bg-white bg-opacity-50 backdrop-blur-lg rounded-lg p-6s">
